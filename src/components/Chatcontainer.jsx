  ...
  return selecteduser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {/* Replace `${selecteduser.fullName}` placeholder with actual name dynamically */}
        {messagesDummyData.map((msg, index) => {
          const text = msg.text && msg.text.includes('${selecteduser.fullName}')
            ? msg.text.replace('${selecteduser.fullName}', selecteduser.fullName)
            : msg.text || '';  // fallback to empty string if undefined
